...
<div class="container-fluid">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar"
        ...
        <div class="offcanvas-footer">
            <button type="button"class="btn icon-link icon-link-hover" style = "color: white;" onclick = "fnLogOf(this)">Sair <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-door-closed" viewBox="0 0 16 16">
